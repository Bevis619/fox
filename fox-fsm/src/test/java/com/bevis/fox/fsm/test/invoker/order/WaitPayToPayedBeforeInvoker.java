 ...
 */
@Service
@StateConfig(biz = "ORDER", from = "HNADING", to = "CANCELED", invokeType = InvokeTypeEnum.BEFORE, order = 3)
public class WaitPayToPayedBeforeInvoker implements StateInvoker<OrderVO, BizTypeEnum, OrderStateEnum> {
    /**
     * Invoke boolean.
     *
